...
class surfaces:
    ...
    def __init__(self
                 ,dir_grid='/scratch/gilbreth/pate2126/DKP_new/model_grid'   #add your paths
        ...
        self.path_ds = '/scratch/gilbreth/pate2126/DKP_new/model_grid/DepthSurfaces_Grid/'                             #add your paths
        self.path_vs = '/scratch/gilbreth/pate2126/DKP_new/model_grid/HUM_Interval_Velocity_Trends/'             #add your path
...
class CO2_pb:
    ...
    def __init__(self
                 ,dir_grid='/scratch/gilbreth/pate2126/DKP_new/model_grid'             #add your path
                 ,path_pb='Sleipner_Plumes_Boundaries/data/'                           #add your path
                 ,fn=None):
        ...
        self.path_pb = '/scratch/gilbreth/pate2126/DKP_new/model_grid/Sleipner_Plumes_Boundaries/data/'      #add your path
        if fn is None:
